        ...
        before(async () => {
            this.deploymentFixture = deployments.createFixture(
                async (_, __?: DeployOptions) => {
                    ...
                    for (var routerAddress of [this.uniswapV3Router, this.uniswapV2Router02, this.curveRouter]) {
                    ...
                    console.log("check");
                    console.log(await this.weth.allowance(this.subject.address, this.uniswapV3Router));
                    console.log(await this.usdc.allowance(this.subject.address, this.uniswapV3Router));
