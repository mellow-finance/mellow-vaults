...
contract ERC20DNRootVaultGovernance is ContractMeta, IERC20DNRootVaultGovernance, VaultGovernance {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return super.supportsInterface(interfaceId) || type(IERC20DNRootVaultGovernance).interfaceId == interfaceId;
    }
    ...
    function createVault(
        ...
        for (uint256 i = 0; i < subvaultNfts_.length; i++) {
...

            {
                ...
                subvault = registry.vaultForNft(subvaultNft);
            }
            ...
            if (i == 0) {
                // The zero-vault must have the same tokens as ERC20DNRootVault
        ...
        vault.initialize(nft, vaultTokens_, strategy_, subvaultNfts_, helper, isSubvaultAndTokenPositive_, specialToken_);
    }

    // -------------------  INTERNAL, VIEW  -------------------

    function _contractName() internal pure override returns (bytes32) {
        return bytes32("ERC20DNRootVaultGovernance");
    }
