...
contract TicksFeesReader {
    ...
    function getTotalRTokensOwedToPosition(
        ...
        require(posManager.addressToPoolId(address(pool)) == pos.poolId, "tokenId and pool dont match");
    ...
    function _deductGovermentFee(IPoolStorage pool, uint256 rMintQty) internal view returns (uint256) {
