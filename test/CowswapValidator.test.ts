...
import { generateSingleParams, randomAddress, withSigner } from "./library/Helpers";
...
contract<CowswapValidator, DeployOptions, CustomContext>("CowswapValidator", function () {
