...
contract<VaultRegistry, DeployOptions, CustomContext>(
    ...
    function () {
        ...
        //                 expect(await this.subject.isLocked(randomNft())).to
        //                     .be.false;
        //             });
        //         });
        //     });
        ...
        describe("#vaultsCount", () => {
            ...
            describe("properties", () => {
                ...
                before(async () => {
                    vaultDeploymentFixture = deployments.createFixture(async () => {
                        console.log(1);
                        await deployments.fixture();
                        console.log(2);
                        ...
                        for (var i = 0; i < 5; ++i) {
                            console.log(4);
                            let newVaultMock = (await MockVaultFactory.deploy()) as MockERC165;
                ...
                pit(
                    ...
                    async (vaultsCount: number): Promise<boolean> => {
                        console.log(6, await this.subject.name());
        ...
        //                 expect(await this.subject.getApproved(this.nft)).to.not.be.equal(
        //                     randomAddr
        //                 );
        //                 expect(await this.subject.getApproved(this.nft)).to.be.equal(
