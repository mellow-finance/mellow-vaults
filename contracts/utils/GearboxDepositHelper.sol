...
contract GearboxDepositHelper is DefaultAccessControl {
    ...
    function _checkIfDepositIsPossible(IGearboxRootVault vault) internal view {
        ...
        if (address(curveAdapter) != address(0)) {
            ...
            uint256 balance0 = curvePool.balances(uint256(0)) *
                10**(18 - ERC20(curvePool.coins(uint256(0))).decimals());
            uint256 balance1 = curvePool.balances(uint256(1)) *
                10**(18 - ERC20(curvePool.coins(uint256(1))).decimals());
