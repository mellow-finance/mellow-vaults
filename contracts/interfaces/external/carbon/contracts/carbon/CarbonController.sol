    ...
    Utils
{
     ...
     */
    function __CarbonController_init() internal {
        __Pairs_init();
        __Strategies_init();
     ...
     */
    function __CarbonController_init_unchained() internal {
    }
     ...
     */
    function setTradingFeePPM(uint32 newTradingFeePPM) external validFee(newTradingFeePPM) {
