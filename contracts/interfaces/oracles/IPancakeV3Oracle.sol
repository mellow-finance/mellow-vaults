...
import "../external/pancakeswap/IPancakeV3Factory.sol";
import "../external/pancakeswap/IPancakeV3Pool.sol";
import "./IOracle.sol";

interface IPancakeV3Oracle is IOracle {
    /// @notice Reference to UniV3 factory
    function factory() external view returns (IPancakeV3Factory);
    ...
    function poolsIndex(address token0, address token1) external view returns (IPancakeV3Pool);
