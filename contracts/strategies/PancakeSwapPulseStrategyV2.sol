...
contract PancakeSwapPulseStrategyV2 is ContractMeta, Multicall, DefaultAccessControlLateInit, ILpCallback {
    ...
    function rebalance(
        ...
        IUniswapV3Pool pool = immutableParams_.pancakeSwapVault.pool();
    ...
    /// @param vaultPool PancakeSwapV3Pool of pancakeSwapVault
    ...
    /// @param mutableParams_ structure with all mutable params of the strategy
    /// @param spotTick current spot tick of PancakeSwapV3Pool of pancakeSwapVault
    /// @param pool PancakeSwapV3Pool of pancakeSwapVault
