        ...
        uint256[] memory erc20Tvl;
        {
            uint256 targetTokenRatioD;
            {
                ...
                if (ratioParams.tickMin + ratioParams.tickNeighborhood > tick) {
                    ratioParams.tickMin = (tick < ratioParams.tickMin ? tick : ratioParams.tickMin) - ratioParams.tickIncrease;
                }
                if (ratioParams.tickMax - ratioParams.tickNeighborhood < tick) {
                    ratioParams.tickMax = (tick > ratioParams.tickMax ? tick : ratioParams.tickMax) + ratioParams.tickIncrease;
                }
