...
contract KyberPulseStrategy is ContractMeta, Multicall, DefaultAccessControlLateInit, ILpCallback {
    ...
    /// @param kyberVault vault containing a algebra position, allowing to add and withdraw liquidity from it
    ...
    function _positionsRebalance(
        ...
        positionManager.transferFrom(address(this), address(vault), newNft);
