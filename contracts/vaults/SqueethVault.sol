...
contract SqueethVault is ISqueethVault, IERC721Receiver, ReentrancyGuard, IntegrationVault, IUniswapV3FlashCallback, PeripheryImmutableState {
    ...
    function _openPosition(uint256 collateral, uint256 toMint, uint256 toRepay) internal {
        ...
        uint256 vaultId = controller.mintWPowerPerpAmount{value: collateral}(
            shortVaultId,
            toMint,
            0
        );
