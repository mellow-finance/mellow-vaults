...
import "../interfaces/vaults/IERC20RetroRootVaultGovernance.sol";
import "../interfaces/vaults/IERC20RetroRootVault.sol";
...
contract ERC20RetroRootVault is IERC20RetroRootVault, ERC20Token, ReentrancyGuard, AggregateVault {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;

    /// @inheritdoc IERC20RetroRootVault
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return super.supportsInterface(interfaceId) || type(IERC20RetroRootVault).interfaceId == interfaceId;
    }
    ...
    function deposit(
        ...
        require(
            !IERC20RetroRootVaultGovernance(address(_vaultGovernance)).operatorParams().disableDeposit,
        ...
        IERC20RetroRootVaultGovernance.DelayedStrategyParams
            memory delayedStrategyParams = IERC20RetroRootVaultGovernance(address(_vaultGovernance))
        ...
        IERC20RetroRootVaultGovernance.StrategyParams memory params = IERC20RetroRootVaultGovernance(
    ...
    function _chargeFees(
        ...
        IERC20RetroRootVaultGovernance vg = IERC20RetroRootVaultGovernance(address(_vaultGovernance));
        uint256 elapsed = block.timestamp - uint256(lastFeeCharge);
        IERC20RetroRootVaultGovernance.DelayedProtocolParams memory delayedProtocolParams = vg.delayedProtocolParams();
        ...
        IERC20RetroRootVaultGovernance.DelayedStrategyParams memory strategyParams = vg.delayedStrategyParams(thisNft);
