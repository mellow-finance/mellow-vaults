...
contract PancakeSwapMerklPulseStrategyV2 is ContractMeta, Multicall, DefaultAccessControlLateInit, ILpCallback {
    ...
    struct ImmutableParams {
        ...
        IPancakeSwapMerklVault pancakeSwapVault;
        address router;
        address[] tokens;
    }
    ...
    function updateFarms(address newLpFarm, address newMerklFarm) external {
        _requireAdmin();
        IPancakeSwapMerklVaultGovernance(address(immutableParams.pancakeSwapVault.vaultGovernance())).setStrategyParams(
                immutableParams.pancakeSwapVault.nft(),
                IPancakeSwapMerklVaultGovernance.StrategyParams({lpFarm: newLpFarm, merklFarm: newMerklFarm})
            );
    }
    ...
    function _positionsRebalance(
        ...
        IPancakeSwapMerklVault vault = immutableParams_.pancakeSwapVault;
    ...
    function _contractName() internal pure override returns (bytes32) {
        return bytes32("PancakeSwapMerklPulseStrategyV2");
    }
