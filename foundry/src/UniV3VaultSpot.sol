...
import "../test/helpers/IUniswapV3Pool.sol";
import "../test/helpers/IUniswapV3Factory.sol";
import "../test/helpers/IUniV3VaultGovernance.sol";
import "../test/helpers/IUniV3Vault.sol";
import "../test/helpers/libraries/TickMath.sol";
import "../test/helpers/libraries/LiquidityAmounts.sol";
...
contract UniV3VaultSpot is IUniV3Vault, IntegrationVault {
    ...
    IUniV3Helper private _uniV3Helper;
    ...
    function tvl() public view returns (uint256[] memory minTokenAmounts, uint256[] memory maxTokenAmounts) {
        ...
        uint128 liquidity;
        {
            ...
            }
            {
                ...
                uint256 priceX96 = _getPrice(params.oracle);
                ...
                maxTokenAmounts[0] += amount0;
                maxTokenAmounts[1] += amount1;
            }
        }
    }

    /// @inheritdoc IntegrationVault
    function supportsInterface(bytes4 interfaceId) public view override(IntegrationVault) returns (bool) {
    ...
    function initialize(
        ...
        _uniV3Helper = IUniV3Helper(uniV3Hepler_);
    ...
    function _getPrice(IOracle oracle) internal view returns (uint256 priceX96) {
        (uint256[] memory prices, ) = oracle.priceX96(_vaultTokens[0], _vaultTokens[1], 0x2);
