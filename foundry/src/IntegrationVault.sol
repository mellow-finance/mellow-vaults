...
import "../test/helpers/IERC1271.sol";
import "../test/helpers/IVaultRoot.sol";
import "../test/helpers/IIntegrationVault.sol";
...
abstract contract IntegrationVault is IIntegrationVault, ReentrancyGuard, Vault {
    ...
    /// @inheritdoc IERC165
    function supportsInterface(bytes4 interfaceId) public view virtual override(Vault) returns (bool) {
        return
